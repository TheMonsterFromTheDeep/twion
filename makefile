...
# Source files
SRCS= main.cpp vector.cpp curve.cpp cubic.cpp window.cpp control.cpp graphics.cpp editor.cpp shape.cpp shapeeditor.cpp colorselector.cpp view.cpp cursors.cpp stb_impl.cpp objecteditor.cpp transform.cpp transformeditor.cpp
